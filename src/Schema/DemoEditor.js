  ...
  return (
    <React.Fragment>
      <SchemaEditor
        ...
        t={browserT}>
        {/* add children that should be under the schema editor, they can use the context of the editor*/}
      </SchemaEditor>
      ...
      <Typography component={"p"} variant={"body1"}>
        ...
        <Link href={"https://github.com/ui-schema/demo-cra/blob/master/src/Schema/DemoEditor.js"}>
